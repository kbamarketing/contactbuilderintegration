...
use KBAMarketing\ContactBuilderIntegration\assetbundles\contactbuilderintegrationfieldfield\ContactbuilderintegrationFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class ContactbuilderintegrationField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('contactbuilderintegration', 'ContactbuilderintegrationField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'contactbuilderintegration/_components/fields/ContactbuilderintegrationField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ContactbuilderintegrationFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ContactbuilderintegrationContactbuilderintegrationField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'contactbuilderintegration/_components/fields/ContactbuilderintegrationField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
